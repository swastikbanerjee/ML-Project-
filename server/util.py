...
def classify_image(image_base64_data, file_path=None):
    ...
    imgs = get_cropped_image_with_features(file_path, image_base64_data)
...
def get_cropped_image_with_features(image_path,image_base64_data):
    face_cascade = cv2.CascadeClassifier('./opencv/haarcascades/haarcascade_frontalface_default.xml')
    nose_cascade = cv2.CascadeClassifier('./opencv/haarcascades/haarcascade_mcs_mouth.xml')
    mouth_cascade = cv2.CascadeClassifier('./opencv/haarcascades/haarcascade_mcs_nose.xml')
...
def get_b64_test_image_for_image():
    with open("b64_2.txt") as f:
        return f.read()

if __name__ == '__main__':
    load_saved_artifacts()

    print(classify_image(get_b64_test_image_for_image(), None))

    # print(classify_image(None, "./test_images/har.jpg"))
    # print(classify_image(None, "./test_images/sen.jpg"))
